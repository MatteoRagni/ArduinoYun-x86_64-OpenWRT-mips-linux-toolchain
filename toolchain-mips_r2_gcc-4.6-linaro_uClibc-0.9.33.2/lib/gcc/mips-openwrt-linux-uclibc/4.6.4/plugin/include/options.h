...
enum opt_code
{
  ...
  OPT_mmt = 1000,                            /* -mmt */
  OPT_mmusl = 1001,                          /* -mmusl */
  OPT_mno_float = 1002,                      /* -mno-float */
  OPT_mno_flush_func = 1003,                 /* -mno-flush-func */
  OPT_mno_mdmx = 1004,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1005,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1006,                     /* -mno-mips3d */
  OPT_mpaired_single = 1007,                 /* -mpaired-single */
  OPT_mplt = 1008,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1009,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1010,               /* -mrelax-pic-calls */
  OPT_mshared = 1011,                        /* -mshared */
  OPT_msingle_float = 1012,                  /* -msingle-float */
  OPT_msmartmips = 1013,                     /* -msmartmips */
  OPT_msoft_float = 1014,                    /* -msoft-float */
  OPT_msplit_addresses = 1015,               /* -msplit-addresses */
  OPT_msym32 = 1016,                         /* -msym32 */
  OPT_msynci = 1017,                         /* -msynci */
  OPT_mtune_ = 1018,                         /* -mtune= */
  OPT_muclibc = 1019,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1020,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1021,                  /* -mvr4130-align */
  OPT_mxgot = 1022,                          /* -mxgot */
  OPT_n = 1023,                              /* -n */
  OPT_no_canonical_prefixes = 1024,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1025,              /* -no-integrated-cpp */
  OPT_noasmopt = 1026,                       /* -noasmopt */
  OPT_nocpp = 1027,                          /* -nocpp */
  OPT_nodefaultlibs = 1028,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1029,                   /* -nostartfiles */
  OPT_nostdinc = 1030,                       /* -nostdinc */
  OPT_nostdinc__ = 1031,                     /* -nostdinc++ */
  OPT_nostdlib = 1032,                       /* -nostdlib */
  OPT_o = 1033,                              /* -o */
  OPT_p = 1034,                              /* -p */
  OPT_pass_exit_codes = 1035,                /* -pass-exit-codes */
  OPT_pedantic = 1036,                       /* -pedantic */
  OPT_pedantic_errors = 1037,                /* -pedantic-errors */
  OPT_pg = 1038,                             /* -pg */
  OPT_pie = 1039,                            /* -pie */
  OPT_pipe = 1040,                           /* -pipe */
  OPT_posix = 1041,                          /* -posix */
  OPT_print_file_name_ = 1042,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1043,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1044,          /* -print-multi-directory */
  OPT_print_multi_lib = 1045,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1046,       /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 1047,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1048,               /* -print-prog-name= */
  OPT_print_search_dirs = 1049,              /* -print-search-dirs */
  OPT_print_sysroot = 1050,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1051,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1052,                        /* -profile */
  OPT_pthread = 1053,                        /* -pthread */
  OPT_quiet = 1054,                          /* -quiet */
  OPT_r = 1055,                              /* -r */
  OPT_rdynamic = 1056,                       /* -rdynamic */
  OPT_remap = 1057,                          /* -remap */
  OPT_s = 1058,                              /* -s */
  OPT_s_bc_abi = 1059,                       /* -s-bc-abi */
  OPT_save_temps = 1060,                     /* -save-temps */
  OPT_save_temps_ = 1061,                    /* -save-temps= */
  OPT_shared = 1062,                         /* -shared */
  OPT_shared_libgcc = 1063,                  /* -shared-libgcc */
  /* OPT_specs = 1064, */                    /* -specs */
  OPT_specs_ = 1065,                         /* -specs= */
  OPT_static = 1066,                         /* -static */
  OPT_static_libgcc = 1067,                  /* -static-libgcc */
  OPT_static_libgcj = 1068,                  /* -static-libgcj */
  OPT_static_libgfortran = 1069,             /* -static-libgfortran */
  OPT_static_libgo = 1070,                   /* -static-libgo */
  OPT_static_libstdc__ = 1071,               /* -static-libstdc++ */
  /* OPT_std_c__03 = 1072, */                /* -std=c++03 */
  OPT_std_c__0x = 1073,                      /* -std=c++0x */
  OPT_std_c__98 = 1074,                      /* -std=c++98 */
  OPT_std_c1x = 1075,                        /* -std=c1x */
  /* OPT_std_c89 = 1076, */                  /* -std=c89 */
  OPT_std_c90 = 1077,                        /* -std=c90 */
  OPT_std_c99 = 1078,                        /* -std=c99 */
  /* OPT_std_c9x = 1079, */                  /* -std=c9x */
  OPT_std_f2003 = 1080,                      /* -std=f2003 */
  OPT_std_f2008 = 1081,                      /* -std=f2008 */
  OPT_std_f95 = 1082,                        /* -std=f95 */
  OPT_std_gnu = 1083,                        /* -std=gnu */
  OPT_std_gnu__0x = 1084,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1085,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1086,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1087, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1088,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1089,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1090, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1091, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1092,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1093, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1094, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1095,                     /* -std=legacy */
  OPT_symbolic = 1096,                       /* -symbolic */
  OPT_t = 1097,                              /* -t */
  OPT_time = 1098,                           /* -time */
  OPT_time_ = 1099,                          /* -time= */
  OPT_tno_android_cc = 1100,                 /* -tno-android-cc */
  OPT_tno_android_ld = 1101,                 /* -tno-android-ld */
  OPT_traditional = 1102,                    /* -traditional */
  OPT_traditional_cpp = 1103,                /* -traditional-cpp */
  OPT_trigraphs = 1104,                      /* -trigraphs */
  OPT_u = 1105,                              /* -u */
  OPT_undef = 1106,                          /* -undef */
  OPT_v = 1107,                              /* -v */
  OPT_version = 1108,                        /* -version */
  OPT_w = 1109,                              /* -w */
  OPT_wrapper = 1110,                        /* -wrapper */
  OPT_x = 1111,                              /* -x */
  OPT_z = 1112,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
